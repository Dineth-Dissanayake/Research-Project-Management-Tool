...
import '../style/add_topic.css'
import {Dropdown} from 'react-bootstrap';
import { Link } from "react-router-dom";


export default class TopicsListAll extends Component {
...
<div className="container">
                ...
                {this.state.topics.map((topics, index) => (
                        <tr key={index}>
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item href={'/topics/edit/'+topics._id}>&nbsp;Edit Request</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                <button type="submit" class="btn btn-outline-primary add-topic">
                    <Link to="/topic/add">Add New Topic</Link>
                </button> 
            </div>
